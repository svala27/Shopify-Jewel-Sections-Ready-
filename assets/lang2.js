window.lang2 = {
    "general": {
        ...
        "accessibility": {
            ...
            "link_messages": {
                ...
                "new_window_and_external": "Öffnet externe Website in einem neuen Fenster."
            },
            "refresh": "refrescar",
            "reset": "Reiniciar",
        ...
        "pagination": {
            ...
            "next": "Nächste Seite",
            "item_per_page": "Artikel pro Seite",
            "current_page": "Artikel {{ current }} zu {{ pageSize }} von {{ total }} gesamt"
        },
        "password_page": {
        ...
        "search": {
            "no_results_html": "Bitte versuchen Sie einen anderen Suchbegriff oder gehen Sie zurück zur <a href=\"{{ link }}\">Startseite</a>.",
        ...
        "newsletter_form": {
            ...
            "email_placeholder": "deine Emailadresse",
            "email_placeholder_fw": "E-Mail Adresse eingeben",
        ...
        "faq": {
            "title": "No es posible encontrar respuestas satisfactorias?"
        }
    },
    "sections": {
        "slideshow": {
    ...
    "blogs": {
        "article": {
            "sidebar_title": "Aktuelle Artikel",
            ...
            "tags": "Stichworte",
            "previous_article": "Älterer Eintrag",
            "next_article": "Neuerer Eintrag"
        },
        "comments": {
    ...
    "cart": {
        "general": {
            ...
            "shipping_calculator_button": "Berechnen Sie Versandkosten",
            "shipping_calculator_calculating": "Rechnen...",
            "shipping_calculator_error_message": "Fehler: Bitte geben Sie die richtigen Versandinformationen ein",
            "shipping_calculator_success_many_rates":
                {
                    "there_are": "Es gibt",
                    "shipping_rates_available_for": "Versandkosten verfügbar für",
                    "starting_at": ", beginnt um"
                },
            "shipping_calculator_success_one_rate": "Es ist eine Versandkostenpauschale für verfügbar",
            "shipping_calculator_success_no_rate": "Für diese Bestellung und diesen Bestimmungsort ist keine Versandgebühr verfügbar.",
            "shipping_calculator_success_at": "beim"
        },
        "label": {
            "product": "Artikel",
            "price": "Preis",
        ...
        "popup": {
            ...
            "quantity": "Menge",
            "quantity_label": "Menge: {{ quantity_count }}"
        }
    },
    "collections": {
        "general": {
    ...
    "customer": {
        ...
        "login": {
            ...
            "note":"Wenn Sie bereits registriert sind, melden Sie sich bitte an.",
            "password": "Passwort",
            "forgot_password": "Haben Sie Ihr Passwort vergessen?",
            "sign_in": "Anmelden",
            "guest_title": "Als Gast fortsetzen",
            "guest_continue": "Fortsetzen",
            "intro_1": "Wenn Sie bereits registriert sind, melden Sie sich bitte an.",
            "intro_2": "Erstellen Sie Ihr Konto und genießen Sie ein neues Einkaufserlebnis."
        },
        "orders": {
            "title": "Bestellungen",
        ...
        "register": {
            ...
            "title_2": "registrieren",
            "note":"Erstellen Sie Ihr Konto und genießen Sie ein neues Einkaufserlebnis.",
            "first_name": "Vorname",
            "last_name": "Nachname",
            "email": "E-Mail",
            "password": "Passwort",
            "submit": "Erstellen",
            "register_title": "Account registrieren",
            "description": "Indem Sie ein Konto erstellen, können Sie schneller einkaufen, den Status einer Bestellung auf dem neuesten Stand halten und den Überblick über Ihre zuvor getätigten Bestellungen behalten."
        }
    },
    "homepage": {
        "onboarding": {
    ...
    "products": {
        "product": {
            ...
            "loader_label": "Produkt wird zum Warenkorb hinzugefügt",
            ...
            "view_cart": "Einkaufswagen einsehen",
            "go_to_cart": "Einkaufswagen einsehen",
            "availability": "Verfügbarkeit",
            "product_type": "Produktcode",
    ...
    "wishlist": {
        "general": {
            "my_wishlist": "Meine Wunschlisten",
            "wishlist": "Wunschlisten",
            "product_image": "Bild",
            "product_name": "Produktname",
            "unit_price": "Einzelpreis",
            "share_wishlist": "Meine Wunschliste per E-Mail teilen",
            "no_login_html": "Um eine Wunschliste zu erstellen, müssen Sie <a href=\"\/account\/login\">Einloggen<\/a> oder <a href=\"\/account\/register\">ein Konto erstellen<\/a>.",
            "add_to_wishlist": "Wunschzettel",
            "remove_wishlist": "Entfernen Wunschliste",
            "note": "Bereits in Ihrer Wunschliste, gehen Sie zur Wunschliste",
            "subtext": "Um eine Wunschliste zu erstellen, müssen Sie",
            "sign_in": "Einloggen",
            "or": "oder",
            "remove": "Entfernen",
            "wishlist_empty": "Sieht so aus, als hättest du noch keine Wunschliste erstellt ...",
    ...
    "general":{
      "title":"Händlersuche",
      "phone":"Rufen Sie uns an + 1900.000.JEWEL",
      "number_phone":"1900.000"
    }
  }
